...
- Once the download is complete, you can utilize the [tools/dataset_converters/nyu.py](/mm_tools/dataset_converters/nyu.py) script to extract and organize the data into the required format. Run the following command in your terminal:
